...
class dao:
        ...
        #########
        ### verify_rich_menu_id
        def verify_rich_menu_id(self, channel_access_token, rich_menu_id):
                headers = {
        ...
        def verify_messaging_api_token(self, channel_access_token):
        ...
        ### list_all_rich_menus
        def list_all_rich_menus(self, channel_access_token):
                headers = {
                        "Authorization": f"Bearer {channel_access_token}"
                }
        ...
        ### list_rich_menus
        def list_rich_menus(self, channel_access_token):
                headers = {
                        "Authorization": f"Bearer " + channel_access_token
                }
        ...
        ### delete_rich_menu
        def delete_rich_menu(self, channel_access_token, rich_menu_id):
                headers = {
                        "Authorization": f"Bearer " + channel_access_token
                }
                url = f"https://api.line.me/v2/bot/richmenu/{rich_menu_id}"
        ...
        ### lean_rich_menus
        def clean_rich_menus(self, channel_access_token):
                menus = self.list_rich_menus(channel_access_token)
                if not menus:
                ...
                if choice == "1":
                        ...
                        if confirm == "yes":
                                for menu in menus:
                                        self.delete_rich_menu(channel_access_token, menu['richMenuId'])
                        else:
                                print("取消刪除。")
                elif choice == "2":
                        rich_menu_id = input("請輸入要刪除的 Rich Menu ID：").strip()
                        self.delete_rich_menu(channel_access_token, rich_menu_id)
                else:
                        print("無效選項，已取消。")
